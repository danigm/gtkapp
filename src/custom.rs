...
use glib;
use glib::{glib_object_subclass, glib_object_impl, glib_wrapper, glib_object_wrapper};
use glib::prelude::*;
use glib::subclass;
...
glib_wrapper! {
    pub struct CustomButton(Object<subclass::simple::InstanceStruct<imp::CustomButton>,
                                   subclass::simple::ClassStruct<imp::CustomButton>,
                                   CustomDataClass>);
    match fn {
        get_type => || imp::CustomButton::get_type().to_glib(),
    }
}
